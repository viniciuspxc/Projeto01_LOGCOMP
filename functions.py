...
def length(formula):
    ...
    if isinstance(formula, Implies) or isinstance(formula, And) or isinstance(
            formula, Or):
...
def substitution(formula, old_subformula, new_subformula):
    ...
    if old_subformula == formula:
      ...
      if isinstance(formula, Implies):
          sub1 = substitution(formula.left, old_subformula, new_subformula)
          sub2 = substitution(formula.right, old_subformula, new_subformula)
          return Implies((sub1),(sub2))
